function save_fig9_data(run_PO_in, run_PR_PTC_multi_in, filename_in)
  % save_fig9_data(run_PO_in, run_PTC_multi_in, filename_in)
  %
  ...
  % for i = 1 : 1
    ...
    if ~lt1_check && ~gt1_check
      % Check if A_perturb > 4.078572
      if A_perturb > 4.078572
