...
%-----------------------------------%
plot_A_perturb = [0.05, 0.1, 0.15, 0.5435, 1.0, 1.5, 2.0];
...
function [theta_old_out, A_perturb_out, theta_new_out] = pad_data(data_in, MX_check)
  ...
  elseif strcmp(MX_check, 'gt1')
    ...
    theta_old_max_length = [theta_old_min, theta_old_max_length];

  elseif strcmp(MX_check, 'lt1')
    % Append the max value
    % theta_old_max_length = [theta_old_max_length, theta_old_max];
    theta_old_max_length = [theta_old_min, theta_old_max_length, theta_old_max];
  ...
  for idx = 1 : length(theta_new_read)
    ...
    % Append the data
    theta_old_out = [theta_old_out; theta_old_max_length];
    theta_new_out = [theta_new_out; theta_new_interp];
    A_perturb_out = [A_perturb_out; A_perturb_temp * ones(1, length(theta_old_max_length))];
