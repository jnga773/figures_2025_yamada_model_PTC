...
% Plot dots
msize = 3;
plot(ax, xbp3_run1(1, 1), xbp3_run1(1, 3), Marker='o', MarkerSize=msize, ...
     MarkerFaceColor=colours(3, :), MarkerEdgeColor='k');
plot(ax, xbp4_run1(1, 1), xbp4_run1(1, 3), Marker='o', MarkerSize=msize, ...
...
%     Axis Limits     %
%---------------------%
ax.XAxis.Limits = [0.9, 1.2];
ax.YAxis.Limits = [2.3, 3];
