...
# Run continuation
run_new = auto.run(c='initial_PO', PAR=p_PO, parnames=pnames_PO)
...
old_functions.write_initial_solution_floquet(run_new('EP1'))
...
# Run continuation
run_new = auto.run(c='floquet_variational', PAR=p_VAR, parnames=pnames_VAR,
