...
load('../plot_mat_files/fig5_data.mat');
...
%     Axis Limits     %
%---------------------%
ax1.XAxis.Limits = [0, 6];
ax1.YAxis.Limits = [-0.5, 50];

ax2.XAxis.Limits = [0, 5];
ax2.YAxis.Limits = [-0.1, 20];
...
%---------------------------------%
% X-Axis
ax1.XAxis.TickValues = 0.0 : 1 : 7;
ax1.XAxis.MinorTickValues = 0.0 : 0.5 : 7.0;

% ax2.XAxis.TickValues      = ax1.XAxis.TickValues;
% ax2.XAxis.MinorTickValues = ax1.XAxis.MinorTickValues;
ax2.XAxis.TickValues = 0.0 : 1 : 5.0;
ax2.XAxis.MinorTickValues = 0.0 : 0.5 : 5.0;

% Y-Axis
ax1.YAxis.TickValues = 0.0 : 10 : 50.0;
ax1.YAxis.MinorTickValues = 0.0 : 5 : 50.0;

% ax2.YAxis.TickValues      = ax1.YAxis.TickValues;
% ax2.YAxis.MinorTickValues = ax1.YAxis.MinorTickValues;
ax2.YAxis.TickValues = 0.0 : 5 : 20.0;
ax2.YAxis.MinorTickValues = 0.0 : 2.5 : 20.0;
...
ax4.YAxis.TickValues = 0.0 : 5 : 20.0;
ax4.YAxis.MinorTickValues = 0.0 : 2.5 : 20.0;
